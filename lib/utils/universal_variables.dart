...
class UniversalVariables {
  ...
  static final Color blueone = Color(0xff003d80);
  static final Color bluetwo = Color(0xff003166);
  static final Color bluethree = Color(0xff00254d);
  static final Color bluefour = Color(0xff001833);
  static final Color bluefive = Color(0xff000c19);
